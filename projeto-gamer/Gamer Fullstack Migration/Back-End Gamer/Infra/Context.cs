    ...
    public class Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
            if (!optionsBuilder.IsConfigured) {
                optionsBuilder.UseSqlServer("""Data Source = DESKTOP-SN4RF4J\SQLEXPRESS; initial catalog = gamerFullStack; User Id = sa; pwd = Senai@134; TrustServerCertificate = true""");
            }
        }
